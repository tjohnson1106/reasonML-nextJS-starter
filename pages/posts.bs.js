...
import * as Post$ReNext from "../src/components/layout/Post.bs.js";
...
var ppx_printed_query = "query ListPostQuery  {\nlistPosts  {\nitems  {\nid  \ntitle  \nbody  \ntags  \ncreatedAt  \nupdatedAt  \nauthor  {\nfirstName  \nlastName  \n}\n\n}\n\n}\n\n}\n";
              ...
              tmp$2 = match$6 !== undefined ? match$6.map((function (value) {
                        ...
                        if (match !== undefined) {
                          ...
                          if (match$1 !== undefined) {
                            ...
                            var match$8 = Js_dict.get(value$1, "tags");
                            var tmp$4;
                            if (match$8 !== undefined) {
                              var value$5 = Caml_option.valFromOption(match$8);
                              var match$9 = Js_json.decodeArray(value$5);
                              ...
                              tmp$4 = Js_exn.raiseError("graphql_ppx: Field tags on type Post is missing");
                            }
                            ...
                            var match$12 = Js_dict.get(value$1, "updatedAt");
                            var tmp$6;
                            if (match$12 !== undefined) {
                              var value$7 = Caml_option.valFromOption(match$12);
                              var match$13 = Js_json.decodeNull(value$7);
                              tmp$6 = match$13 !== undefined ? undefined : Caml_option.some(value$7);
                            } else {
                              tmp$6 = undefined;
                            }
...
function Posts(Props) {
  var match = Curry._8(ListPostQuery.use, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0);
  var simple = match[0];
  var tmp;
  tmp = typeof simple === "number" ? (
      simple === /* Loading */0 ? React.createElement("p", undefined, "Loading...") : React.createElement("p", undefined, "No posts available!")
    ) : (
      simple.tag ? React.createElement("p", undefined, "No posts available!") : Belt_Option.mapWithDefault(Belt_Option.flatMap(simple[0].listPosts, (function (listPosts) {
                ...
                return Belt_Array.map(items, (function (item) {
                              return Belt_Option.mapWithDefault(item, null, (function (item) {
                                            ...
                                            return React.createElement(Post$ReNext.make, {
                                                        title: item.title,
                                                        body: item.body,
                                                        tags: item.tags,
  ...
  return React.createElement(Section$ReNext.make, {
              ...
              children: React.createElement("div", {
                  ...
                  }, tmp, React.createElement(Post$ReNext.make, { }), React.createElement(Post$ReNext.make, { }), React.createElement(Post$ReNext.make, { }), React.createElement(Post$ReNext.make, { }), React.createElement(Post$ReNext.make, { }))
            });
}
